...
phi = CellVariable(name="Wind speed",
                   mesh=mesh,
                   value=0.)
...
#Setting up boundary conditions. This is the simple case of Dirichlet case.
#The assumption is The wind is coming into and getting out of our system
#at a constant speed, the motion of wind will not be effected much by the
#shape of the surface and the wind speed will be zero at the surface.
